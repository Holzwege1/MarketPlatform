...
CREATE TABLE `award` (
  ...
  `award_key` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '策略标记',
...
VALUES
	(1,101,'user_credit_random','1,100','用户积分【优先规则范围，没有则走配置】','2025-10-24 00:09:45','2025-10-24 00:09:45'),
	(2,102,'optional_use_count','5','OpenAI增加使用次数','2025-10-24 00:10:14','2025-10-24 00:10:14'),
	(3,103,'optional_use_count','10','OpenAI增加使用次数','2025-10-24 00:10:44','2025-10-24 00:10:44'),
	(4,104,'optional_use_count','20','OpenAI增加使用次数','2025-10-24 00:11:16','2025-10-24 00:11:16'),
	(5,105,'optional_model','gpt-4','OpenAI增加模型','2025-10-24 00:11:43','2025-10-24 00:11:43'),
	(6,106,'optional_model','dall-e-2','OpenAI增加模型','2025-10-24 00:12:13','2025-10-24 00:12:13'),
	(7,107,'optional_model','dall-e-3','OpenAI增加模型','2025-10-24 00:12:13','2025-10-24 00:12:13'),
	(8,108,'optional_use_count','100','OpenAI增加使用次数','2025-10-24 00:12:13','2025-10-24 00:12:13'),
	(9,109,'optional_model','gpt-4,dall-e-2,dall-e-3','OpenAI增加模型','2025-10-24 00:13:30','2025-10-24 00:13:30');
